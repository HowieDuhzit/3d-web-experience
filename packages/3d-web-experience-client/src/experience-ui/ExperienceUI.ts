...
export type ExperienceUIConfig = {
  ...
  defaultPostProcessingEnabled?: boolean;
};
    ...
    try {
      const basePreferences: StoredPreferences = {
        ...
        postProcessingEnabled:
          this.config.defaultPostProcessingEnabled ?? defaultPreferences.postProcessingEnabled,
        uiScale: this.config.defaultUiScale ?? defaultPreferences.uiScale,
      };
      ...
      return {
        ...basePreferences,
        ...parsed,
        uiScale: parsed.uiScale ?? basePreferences.uiScale,
        postProcessingEnabled:
          parsed.postProcessingEnabled ?? basePreferences.postProcessingEnabled,
      };
    } catch {
      return {
        ...defaultPreferences,
